...
Exemplo: se a função receber a string `"go Diego"`, o retorno deverá ser `['go', 'Diego']`.

**O que será verificado:**

- Retorne o valor ['go', 'Diego'] se a função receber a string 'go Diego'

- Retorne o valor ['so', 'que', 'nao']. se a função receber a string 'so que nao'

- Retorne o valor ['foi'] se a função receber a string 'foi'
...
### 13 - Crie uma função de boas vindas ao Bauteco!
